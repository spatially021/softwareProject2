...
#define _DUTY_MAX 1970 // 2000
#define _DUTY_NEU 1572 // 1500
#define _DUTY_MIN 791 // 1000

#define _SERVO_ANGLE_DIFF  57  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = ir_sensor_filtered(100,0.5 , 0);
